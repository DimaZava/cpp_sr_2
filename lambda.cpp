...
void example_3() {
    ...
    auto closure = [z = 100](int a, int b) {
        return z + a + b;
    };
    std::cout << closure(1, 2) << std::endl;
    auto closure1 = [z = 100.1](int a, int b) {
        return z + a + b;
    };
    std::cout << closure1(1, 2) << std::endl;
...
void example_4() {
    ...
    auto closure2 = [z = 100](int a, int b) mutable -> decltype(a + b) {
        z = 150;
        return a + b + z;
    };
    closure2(2, 3);

    auto closure3 = [](auto a, auto b) {
        return a + b;
    };
